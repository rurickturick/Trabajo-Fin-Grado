...
public class Clasificador {
	...
	public static HashMap<String,String> getClasificacion(String dia, String mes, String año, String lugar){
		DBCursor tmp = mongoDBHandler.recuperarTT(dia,  mes,  año,  lugar);
		...
		while(tmp.hasNext()){
			DBObject aux=tmp.next();
	    	   ...
	    	   DBCursor tmp2=mongoDBHandler.recuperarClasificacion(dia,  mes,  año,  tt);
	    	   while(tmp2.hasNext()){
	    		   DBObject aux2 = tmp2.next();
